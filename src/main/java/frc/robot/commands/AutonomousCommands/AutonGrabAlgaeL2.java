 ...
 *
 */
public class AutonGrabAlgaeL2 extends SequentialCommandGroup {
    ...
    public AutonGrabAlgaeL2(Shoulder m_shoulder, ElevatorS1 m_elevatorS1, ElevatorS2 m_elevatorS2, Algae m_algae) {
        // Add Commands here:
        // Also add parallel commands using the
        //
        addCommands(
                new InstantCommand(() -> Robot.getInstance().goalArrangementOthers(PoseSetter.AlgaeGrab + "L2")),
