 ...
 *
 */
public class AutonGrabAlgaeLow extends SequentialCommandGroup {
   ...
   // public AutoRaiseCoral(Elevator elevator){
    ...
    public AutonGrabAlgaeLow(Shoulder m_shoulder, ElevatorS1 m_elevatorS1, ElevatorS2 m_elevatorS2, Algae m_algae){
        // Add Commands here:
        // Also add parallel commands using the
        //
        addCommands(
              new InstantCommand(() -> Robot.getInstance().goalArrangementOthers(PoseSetter.AlgaeGrab + "L1")),
