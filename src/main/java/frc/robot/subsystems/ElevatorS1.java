...
public class ElevatorS1 extends SubsystemBase {
    ...
    */
    public ElevatorS1() {
        ...
        // SoftwareLimitSwitchConfigs elevatorLowerSoftSwitch =
        // elevatorLowerConfig.SoftwareLimitSwitch;
        ...
        // motionMagicU.withMotionMagicCruiseVelocity(RotationsPerSecond.of(9999)) // (meachanism) rotations per second
                                                                                // cruise
        ...
        motionMagicL.withMotionMagicCruiseVelocity(RotationsPerSecond.of(10)) // (meachanism) rotations per second
                                                                              // cruise
    ...
    public void periodic() {
        ...
        // SmartDashboard.putNumber("Bottom Vol",
        // stage1motor.getVelocity().getValueAsDouble());
        SmartDashboard.putNumber("Bottom Pos", stage1motor.getPosition().getValueAsDouble());
        // SmartDashboard.putNumber("Top Vol",
        // stage2motor.getVelocity().getValueAsDouble());
        ...
        // if (getBottomSwitch() && stage1motor.getPosition().getValueAsDouble()!=
        // Constants.ElevatorConstants.stage1LowerLimit) {
        // stage1motor.setPosition(Constants.ElevatorConstants.stage1LowerLimit);

        // }
        // if (getTopSwitch() && Math.abs(stage2motor.getPosition().getValueAsDouble() -
        // Constants.ElevatorConstants.stage2UpperLimit) < 0.1) {
    ...
    public void stopMotorS1() {
        stage1motor.set(0);
    }

    // public void stopMotorS2() {
    //     stage2motor.set(0);
    // }

    public void setElevatorZeroingDownS1() {
        stage1motor.set(-0.25);
    }

    public void setElevatorZeroingUpS1() {
        stage1motor.set(0.1);
    }
    ...
    // public void setElevatorZeroingUpS2() {
    //     stage2motor.set(0.2);
    // }

    // public void setElevatorZeroingDownS2() {
    //     stage2motor.set(-0.1);
    // }
    ...
    // double currPos =
    // Robot.getInstance().m_shoulder.shoulderMotor.getPosition().getValueAsDouble();
    ...
    public boolean getStalledS1() {
        return stage1motor.getFault_StatorCurrLimit().getValue() && Math.abs(stage1motor.getRotorVelocity().getValueAsDouble()) < 0.5;
    }

    // public boolean getStalledS2() {
    //     return stage2motor.getFault_StatorCurrLimit().getValue() && Math.abs(stage2motor.getRotorVelocity().getValueAsDouble()) < 0.5; 
    // }
}
